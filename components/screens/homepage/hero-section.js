    ...
    <section className='min-h-screen relative px-4 max-w-[1124px] lg:mx-auto'>
      ...
      h-[78vh] flex flex-col justify-center'>
        ...
        >
          ...
          <p className='mt-6'>
            Pupuk buatan kami merupakan pupuk yang telah <br className='hidden md:inline'/>
            diproses ketat dan melalui quality control yang baik, <br className='hidden md:inline'/>
            sehingga dapat menunjang tanaman dengan sangat baik.
          </p>
          <div className='w-max mt-12'>
            <Link href='/'>
              <a className='border border-primary text-white bg-primary hover:text-primary 
