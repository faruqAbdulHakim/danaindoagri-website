...
export default function RevenueDetailScreen({ OrderDetail }) {
  return <>
    ...
    <div className='h-[calc(100vh-90px)] p-6 overflow-scroll'>
        ...
        <div className='mt-4 flex gap-8'>
          <div className='h-60 w-60 relative bg-slate-50 rounded-md overflow-hidden'>
            <Image src={`${PRODUCTS_BASE_URL}/${OrderDetail.products.imgUrl}`} alt='Tidak ada gambar' layout='fill' />
          </div>
          <div className='max-w-sm'>
            ...
            <div className='space-y-2'>
              ...
              <div>
                ...
                <p>
                  {OrderDetail.address}, {' '}
                  {OrderDetail.cities.citytype.type} {' '}
                  {OrderDetail.cities.city}, {' '}
                  {OrderDetail.cities.provinces.province}
                </p>
              </div>
            </div>
